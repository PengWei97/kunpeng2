...
[Kernels]
  ...
  [./eta_interface]
    ...
    variable = eta
    kappa_name = 1
    # the gradient energy coefficent
  [../]
  [./time]
    type = TimeDerivative
    variable = eta
...
[Materials]
  ...
  [./elastic_free_energy_a]
    ...
    base_name = phasea
    f_name = Fea
    # Base name of the free energy function (used to name the material properties) concatenate the material property names for the derivatives.
    block = 0
    args = ''
  [../]
